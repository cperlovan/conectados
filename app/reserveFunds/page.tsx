          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            {loading ? (
              ...
              <div className="text-center py-10 border-t border-gray-200 mt-6">
                ...
                <h3 className="mt-2 text-lg font-medium text-gray-900">No hay fondos de reserva registrados</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Actualmente no hay fondos de reserva creados para este condominio. ¡Empieza creando uno!
                </p>
                <div className="mt-6">
                  <button
                    onClick={() => router.push('/reserveFunds/create')}
